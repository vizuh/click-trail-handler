	...
	private function get_unified_admin_settings() {
		...
		return array(
			...
			'events'          => array(
				...
				'woocommerce_funnel_server_events' => ! empty( $feature_flags['woocommerce_funnel_server_events'] ) ? 1 : 0,
	...
	private function save_unified_admin_settings( $payload ) {
		...
		$tracking_input = array(
			'feature_flags'  => array(
				...
				'woocommerce_funnel_server_events' => ! empty( $events['woocommerce_funnel_server_events'] ) ? 1 : 0,
