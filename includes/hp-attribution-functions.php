 ...
 */
function hp_get_attribution() {
	if ( isset( $_COOKIE['hp_attribution'] ) ) {
		$cookie_value = stripslashes( $_COOKIE['hp_attribution'] );
 ...
 */
function hp_get_attribution_field( $type, $field ) {
	$data = hp_get_attribution();
